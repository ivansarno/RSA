...
namespace RSA
{
    ...
    int Foult(BigInteger &pubkey, BigInteger &privkey, BigInteger &modulus, RSA::Utils::Generator *gen, unsigned int size=1024, unsigned int precision=20, unsigned long distance=UINT32_MAX);
}
